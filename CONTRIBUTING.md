# Contributing to @frontend-configs

Open source projects like `@frontend-configs` live on your words of encouragement and contribution. Please give feedback, report issues, or submit pull requests!
...
1. Fork and clone this repo.
    ...
    ```sh
    git clone git@github.com:<your-github-handle>/frontend-configs.git
    ```
...
1. [Create a tag](https://github.com/ijlee2/frontend-configs/releases/new) and provide release notes. The tag name should match the workspace root's version (e.g. `0.1.2`).
...
1. An open source project's value comes from people using the code and extending it to make greater things. Let me know how you use `@frontend-configs` in your codemod!

1. You can **create an issue** to:

    - Share how you used `@frontend-configs`
    - Share what you liked or didn't like about `@frontend-configs`
...
1. When reporting a bug, please provide details to help me understand what's going on. If possible, please use the latest version of `@frontend-configs` and set up a public demo that I (and others) can check the code.
